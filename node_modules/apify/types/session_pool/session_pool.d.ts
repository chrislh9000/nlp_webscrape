...
export class SessionPool extends EventEmitter {
    ...
    log: any;
    maxPoolSize: number;
    createSessionFunction: CreateSession & Function;
    sessionOptions: {
        log: any;
    };
     ...
     * @internal
     */
    protected _removeSession(session: Session): void;
    /**
     ...
     * @internal
     */
    protected _defaultCreateSessionFunction(sessionPool: SessionPool): Session;
    /**
