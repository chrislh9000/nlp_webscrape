...
export function addWebhook(options: {
    eventTypes: ("ACTOR.RUN.SUCCEEDED" | "ACTOR.RUN.ABORTED" | "ACTOR.RUN.CREATED" | "ACTOR.RUN.FAILED" | "ACTOR.RUN.TIMED_OUT")[];
    requestUrl: string;
...
export type EventTypes = ("ACTOR.RUN.SUCCEEDED" | "ACTOR.RUN.ABORTED" | "ACTOR.RUN.CREATED" | "ACTOR.RUN.FAILED" | "ACTOR.RUN.TIMED_OUT")[];
