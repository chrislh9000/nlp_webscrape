 ...
 * @ignore
 */
declare class BrowserCrawler extends BasicCrawler {
    static optionsShape: {
        ...
        browserPoolOptions: import("ow/dist").ObjectPredicate<object>;
   ...
   */
    ...
    handlePageFunction: BrowserHandlePageFunction & Function;
    handlePageTimeoutSecs: number;
    handlePageTimeoutMillis: number;
    gotoFunction: GotoFunction & Function;
    defaultGotoOptions: {};
     ...
     * @internal
     */
    protected _handleRequestFunction(crawlingContext: BrowserCrawlingContext & CrawlingContext): Promise<void>;
    /**
     * @param {BrowserCrawlingContext & CrawlingContext} crawlingContext
     * @param {*} page
     * @ignore
     ...
     * @internal
     */
    protected _enhanceCrawlingContextWithPageInfo(crawlingContext: BrowserCrawlingContext & CrawlingContext, page: any): void;
    /**
     * @param {BrowserCrawlingContext & CrawlingContext} crawlingContext
     * @ignore
     * @protected
     ...
     * @internal
     */
    protected _maybeAddSessionRetiredListener(pageId: string, browserController: any): void;
    /**
     ...
     * @internal
     */
    protected _executeHooks(hooks: Hook[], ...args: any): Promise<void>;
}
