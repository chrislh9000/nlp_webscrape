...
declare class BasicCrawler {
    static optionsShape: {
        ...
        handleRequestFunction: import("ow/dist").Predicate<Function>;
    ...
    /** @type {defaultLog.Log} */
    log: defaultLog.Log;
    requestList: RequestList & object;
    requestQueue: RequestQueue & object;
    userProvidedHandler: HandleRequest & Function;
    failedContextHandler: HandleFailedRequest & Function;
    handleRequestTimeoutMillis: number;
    handleFailedRequestFunction: HandleFailedRequest & Function;
    maxRequestRetries: number;
