 ...
 * @ignore
 */
export function extractUrlsFromPage(page: PuppeteerPage | PlaywrightPage, selector: string): Promise<string[]>;
/**
 ...
 * @ignore
 */
export function extractUrlsFromCheerio($: cheerio.Selector | cheerio.Root, selector: string, baseUrl: string): string[];
