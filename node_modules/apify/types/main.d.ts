...
declare const exportedUtils: {
    ...
    htmlToText: (html: string | cheerio.Root) => string;
    ...
    requestAsBrowser: (options: import("./utils_request").RequestAsBrowserOptions) => Promise<import("http").IncomingMessage & import("stream").Readable & {
        body: string;
    }>;
};
import log from "./utils_log";
import { enqueueLinks } from "./enqueue_links/enqueue_links";
export { main, getEnv, call, callTask, metamorph, getMemoryInfo, isAtHome, newClient, addWebhook, AutoscaledPool, BasicCrawler, CheerioCrawler, pushData, openDataset, events, initializeEvents, stopEvents, getValue, setValue, getInput, openKeyValueStore, launchPuppeteer, launchPlaywright, BrowserCrawler, PuppeteerCrawler, PlaywrightCrawler, PseudoUrl, Request, RequestList, openRequestList, openRequestQueue, openSessionPool, createProxyConfiguration, LiveViewServer, Session, exportedUtils as utils };
