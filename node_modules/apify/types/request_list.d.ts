...
export class RequestList {
     ...
     * @internal
     */
    protected _loadStateAndPersistedRequests(): Promise<(RequestListState | null)[]>;
    /**
     ...
     * @internal
     */
    protected _fetchRequestsFromUrl(source: any): Promise<RequestOptions[]>;
    /**
     * Adds given request.
     ...
     * @internal
     */
    protected _addRequest(source: string | object | Request): void;
    /**
...
export type RequestListSourcesFunction = () => Promise<(string | Request | RequestOptions)[]>;
