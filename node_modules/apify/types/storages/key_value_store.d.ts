...
export class KeyValueStore {
     ...
     */
    getValue(key: string): Promise<string | Buffer | {
        [x: string]: any;
    } | null>;
    /**
     ...
     *
     */
    setValue(key: string, value: string | Buffer | {
        [x: string]: any;
    } | null, options?: {
        contentType?: string;
...
export function getValue(key: string): Promise<string | Buffer | {
    [x: string]: any;
} | null>;
export function setValue(key: string, value: any, options?: {
    contentType?: string;
} | undefined): Promise<void>;
export function getInput(): Promise<string | Buffer | {
    [x: string]: any;
} | null>;
export type KeyValueStoreValueTypes = string | Buffer | {
    [x: string]: any;
} | null;
/**
