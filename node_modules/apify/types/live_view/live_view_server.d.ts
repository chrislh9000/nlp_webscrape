...
declare class LiveViewServer {
     ...
     * @internal
     */
    protected _getScreenshotPath(screenshotIndex: number): string;
    /**
     * @param {Page} page
     ...
     * @internal
     */
    protected _makeSnapshot(page: Page): Promise<Snapshot>;
    /**
     ...
     * @internal
     */
    protected _pushSnapshot(snapshot: Snapshot): void;
    /**
     ...
     * @internal
     */
    protected _deleteScreenshot(screenshotIndex: number): void;
    /**
     * @ignore
     * @protected
     * @internal
     */
    protected _setupHttpServer(): void;
     ...
     * @internal
     */
    protected _socketConnectionHandler(socket: socketio.Socket): void;
}
