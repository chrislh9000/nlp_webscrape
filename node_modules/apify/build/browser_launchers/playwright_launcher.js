...
class PlaywrightLauncher extends browser_launcher_1.default {
    ...
    */
    constructor(launchContext = {}) {
        ow_1.default(launchContext, 'PlaywrightLauncherOptions', ow_1.default.object.exactShape(PlaywrightLauncher.optionsShape));
...
PlaywrightLauncher.optionsShape = {
 ...
 * @function
 */
exports.launchPlaywright = async (launchContext) => {
