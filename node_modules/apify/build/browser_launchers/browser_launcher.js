...
class BrowserLauncher {
    ...
    */
    constructor(launchContext) {
        ow_1.default(launchContext, 'BrowserLauncherOptions', ow_1.default.object.exactShape(BrowserLauncher.optionsShape));
        const { launcher, proxyUrl, useChrome, launchOptions = {}, } = launchContext;
    ...
    */
    _getChromeExecutablePath() {
        return process.env[consts_1.ENV_VARS.CHROME_EXECUTABLE_PATH] || utils_1.getTypicalChromeExecutablePath();
    }
    /**
     *
