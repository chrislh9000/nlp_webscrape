...
const browser_launcher_1 = require("./browser_launcher");
...
class PuppeteerLauncher extends browser_launcher_1.default {
    ...
    */
    constructor(launchContext = {}) {
        ow_1.default(launchContext, 'PuppeteerLauncher', ow_1.default.object.exactShape(PuppeteerLauncher.optionsShape));
        const { launcher = browser_launcher_1.default.requireLauncherOrThrow('puppeteer', 'apify/actor-node-chrome-*'), userAgent, stealth = false, stealthOptions = {}, ...browserLauncherOptions } = launchContext;
        super({
    ...
    async launch() {
        ...
        if (this.stealth) {
            ...
            stealth_1.default(browser, newStealthOptions);
        }
        return browser;
    }
    createLaunchOptions() {
...
PuppeteerLauncher.optionsShape = {
 ...
 * @function
 */
exports.launchPuppeteer = async (launchContext) => {
