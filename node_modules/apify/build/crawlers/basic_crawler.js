...
class BasicCrawler {
     ...
     */
    constructor(options) {
        ow_1.default(options, 'BasicCrawlerOptions', ow_1.default.object.exactShape(BasicCrawler.optionsShape));
    ...
    async _runTaskFunction() {
        ...
        const crawlingContext = {
            id: utilities_1.cryptoRandomObjectId(10),
            crawler: this,
            request,
            session,
        };
        ...
        try {
            await utils_1.addTimeoutToPromise(this._handleRequestFunction(crawlingContext), this.handleRequestTimeoutMillis, `handleRequestFunction timed out after ${this.handleRequestTimeoutMillis / 1000} seconds.`);
