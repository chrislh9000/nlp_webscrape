...
const events_1 = require("../session_pool/events"); // eslint-disable-line import/no-duplicates
 ...
 * @ignore
 */
class BrowserCrawler extends basic_crawler_1.default {
    /**
   * @param {BrowserCrawlerOptions} options
   * All `BrowserCrawler` parameters are passed via an options object.
   */
    constructor(options) {
        ow_1.default(options, 'BrowserCrawlerOptions', ow_1.default.object.exactShape(BrowserCrawler.optionsShape));
        const { handlePageFunction, handlePageTimeoutSecs = 60, gotoFunction, persistCookiesPerSession, useSessionPool = true, sessionPoolOptions, proxyConfiguration, browserPoolOptions, preNavigationHooks = [], postNavigationHooks = [], ...basicCrawlerOptions } = options;
        ...
        if (useSessionPool) {
            ...
            this.sessionPool = new session_pool_1.SessionPool({
                ...sessionPoolOptions,
                log: this.log,
            });
    ...
    _handleNavigationTimeout(crawlingContext, error) {
        ...
        if (error && error.constructor.name === 'TimeoutError') {
            crawler_utils_1.handleRequestTimeout(session, error.message);
        }
    }
    /**
     * @param {BrowserCrawlingContext & CrawlingContext} crawlingContext
    ...
    async _responseHandler(crawlingContext) {
        ...
        if (this.sessionPool && response) {
            if (typeof response === 'object' && typeof response.status === 'function') {
                crawler_utils_1.throwOnBlockedRequest(session, response.status());
            }
            else {
...
BrowserCrawler.optionsShape = {
    ...basic_crawler_1.default.optionsShape,
