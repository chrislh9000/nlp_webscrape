...
class PlaywrightCrawler extends browser_crawler_1.default {
     ...
     */
    constructor(options) {
        ow_1.default(options, 'PlaywrightCrawlerOptions', ow_1.default.object.exactShape(PlaywrightCrawler.optionsShape));
        const { launchContext = {}, gotoTimeoutSecs, navigationTimeoutSecs, browserPoolOptions = {}, ...browserCrawlerOptions } = options;
    ...
    async _navigationHandler(crawlingContext, gotoOptions) {
        ...
        return playwright_utils_1.gotoExtended(crawlingContext.page, crawlingContext.request, gotoOptions);
    }
}
