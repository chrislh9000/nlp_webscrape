...
const browser_crawler_1 = require("./browser_crawler");
...
class PuppeteerCrawler extends browser_crawler_1.default {
    ...
    */
    constructor(options = {}) {
        ow_1.default(options, 'PuppeteerCrawlerOptions', ow_1.default.object.exactShape(PuppeteerCrawler.optionsShape));
        const { launchContext = {}, // @TODO: should not launcher be inside launchContext
        gotoTimeoutSecs, navigationTimeoutSecs, browserPoolOptions = {}, proxyConfiguration, ...browserCrawlerOptions } = options;
        ...
        if (stealth) {
            this.browserPool.postLaunchHooks.push(async (pageId, browserController) => {
                ...
                await stealth_1.default(browserController.browser, newStealthOptions);
            });
        }
    ...
    async _navigationHandler(crawlingContext, gotoOptions) {
        ...
        return puppeteer_utils_1.gotoExtended(crawlingContext.page, crawlingContext.request, gotoOptions);
    }
}
